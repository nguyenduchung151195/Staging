...
class ExtendedInformation extends React.Component {
  ...
  handleInputChangeDate = (e, fieldName) => {
    ...
    console.log([name], 'ccc', value);
    // setLocalState({ ...localState, [name]: value });
  };

  handleChangeDate = (e, fieldName, name) => {
    const { moduleCode } = this.props;
    const { localMessages } = this.state;
    const messages = viewConfigHandleOnChange(moduleCode, localMessages, fieldName, e);
    this.setState({
      [name]: e,
      localMessages: messages
    });
  ...
  render() {
    ...
    return (
      <div>
        {/* {
          console.log(name2Title, 'name2Title')
        } */}
        <div>
          <div>
            <Grid container>
              <Grid md={3}>
                <FormGroup>
                  <FormControlLabel
                    ...
                    label={name2Title['otherInfo.taxInclude'] || "otherInfo.taxInclude"}
                    labelPlacement="end"
                  />
                </FormGroup>
              </Grid>
              ...
              <Grid md={3}>
                <FormGroup>
                  <FormControlLabel
                    ...
                    label={name2Title['otherInfo.commission.status'] || "otherInfo.commission.status"}
                    labelPlacement="end"
                  />
                </FormGroup>
              </Grid>
            ...
            <div>
              ...
              <FormGroup style={{ textAlign: 'left', width: '25%' }}>
                <FormControlLabel
                  ...
                  label={name2Title['otherInfo.isSale'] || "otherInfo.isSale"}
                  labelPlacement="end"
                />
              </FormGroup>
              {this.state.isSale ? (
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <form className={classes.container} style={{ width: '40%' }} noValidate>
                      <CustomDatePicker
                        ...
                        onChange={e => this.handleInputChangeDate(e, 'startDayForSale')}
                    ...
                    <form className={classes.container} style={{ width: '40%' }} noValidate>
                      <CustomDatePicker
                        ...
                        name="endDayForSale"
                        onChange={e => this.handleInputChangeDate(e, 'endDayForSale')}
          ...
          <div>
              ...
              <Grid md={3}>
                <FormGroup>
                  <FormControlLabel
                    ...
                    label={name2Title['otherInfo.isUnitChange'] || "otherInfo.isUnitChange"}
                    labelPlacement="end"
                  />
                </FormGroup>
              </Grid>
              ...
              <div>
                <div>
                  ...
                  <Grid container style={{ marginBottom: '1rem' }}>
                    <Button size="small" onClick={this.handleAddField} variant="outlined" color="primary">
                      Thêm trường
                    </Button>
                  </Grid>
                </div>
            ...
            {/* <CustomInputBase
              ...
              name="dateExpire"
              type="date"
              onChange={e => this.handleChangeDate(e ? moment(e).format("DD/MM/YYYY") : null, 'otherInfo.expirationDate', "dateExpire")}
            ...
            <div>
              <MuiPickersUtilsProvider utils={MomentUtils}>
                <DatePicker
                  ...
                  //  disableFuture
                  openTo="day"
                  onChange={e => this.handleChangeDate(e, 'otherInfo.expirationDate', "dateExpire")}
                  InputProps={{
                    endAdornment: (
                      <IconButton >
                        <TodayIcon />
